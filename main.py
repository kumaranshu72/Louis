...
import time
from VoiceIt import *
from searchModule import sm
from plmusic import mus
from calci import calculator

#open USER data
data = json.load(open('./Desktop/major/data/sim.json'))
...
while(True):
    ...
    os.system("echo '\a'")
    response = myVoiceIt.authentication(data['userName'], data['password'], "./Desktop/major/sound/file.wav", "en-US")
